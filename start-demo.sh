...
echo "- App:           8083 (instead of 8081, 8082 is for frontend)"
...
echo "- Swagger Docs:       http://localhost:8083/docs"
...
echo "curl -X POST http://localhost:8083/api/event/processVoiceFolder -u tipax:opera-qc-2024 -H 'Content-Type: application/json'"